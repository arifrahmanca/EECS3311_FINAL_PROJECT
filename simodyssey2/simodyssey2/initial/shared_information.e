...
feature
	...
	janitaur_max_fuel: INTEGER = 5
	janitaur_reproduction : INTEGER = 2
	janitaur_max_load : INTEGER = 2

	benign_max_fuel: INTEGER = 3
	benign_reproduction : INTEGER = 1

	malevolent_max_fuel : INTEGER = 3
	malevolent_reproduction : INTEGER = 1

	next_moveable_id: INTEGER
		do
			Result := next_id
			next_id := next_id + 1
		end
